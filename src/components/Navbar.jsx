      ...
      <div className="navbar w-screen py-1 px-4 md:px-20 bg-slate-950/40 backdrop-blur-lg shadow-md shadow-white h-16 fixed top-0 z-100">
        ...
        {menu && (
          <div className="mobile left-box ">
            ...
            initial="hidden"
            animate="visible"
             className="md:hidden text-slate-800 md:text-white h-screen font-700 flex flex-col justify-center items-center space-y-3 fixed top-0 left-0 right-0 font-semibold text-lg bg-slate-950/80 backdrop-blur-xl">
              <motion.li variants={navItemVariants}>
                <Link
                  to="Home"
                  onClick={() => setMenu(!menu)}
